    ...
    <div>
      ...
      <div className="relative flex justify-center items-center min-h-screen overflow-hidden bg-[#1b2a1f]">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-2 w-full py-3 rounded-md bg-green-400/20 text-white font-semibold border-2 border-green-400 transition-transform hover:scale-105 hover:bg-green-400/40"
          >
            Register
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full py-3 rounded-md bg-white/90 text-gray-800 font-semibold hover:bg-white shadow-[2px_2px_6px_rgba(0,0,0,0.2)] transition-transform hover:scale-105"
          >
