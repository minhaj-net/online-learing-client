...
const Switch = () => {
  ...
  useEffect(() => {
    ...
    // ✅ keep checked state synced with theme
      ...
      <label className="relative w-[95px] h-full cursor-pointer">
        ...
        <div className="relative w-full h-full bg-[#252532] rounded-[165px] border border-[#32303e] p-[6px] shadow-[inset_0_5px_10px_0_#16151c,0_3px_6px_-2px_#403f4e] flex items-center">
          <div className="relative w-full h-full flex justify-between">
            <span
              className={`absolute h-[42px] w-[42px] rounded-full bg-gradient-to-b from-[#3b3a4e] to-[#272733] shadow-[inset_0_5px_4px_0_#424151,0_4px_15px_0_#0f0e17] transition-all duration-300 ease-in z-20 ${
