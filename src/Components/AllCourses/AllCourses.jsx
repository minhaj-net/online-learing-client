      ...
      <div className="relative z-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 w-full lg:w-3/4">
        {filteredData.map((course, i) => (
            <motion.div
              ...
              className="bg-[#0d3325]/70 border border-green-900/30 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-green-700/30 transition-all duration-300 overflow-hidden flex flex-col max-h-[450px]"
            >
              {/* Image */}
